...
class FunctionRegistry {
    ...
    init(layer: Int, substitutionTable: [UInt8], randomValue: UInt8) {
        self.obfuscationLayer = min(max(layer, 1), 4)
        self.functionRegistry = ObfuscationFunctionRegistry(substitutionTable: substitutionTable, randomValue: randomValue)
        self.functions = functionRegistry.functions
